...
const Shapes = () => {
  return (
    <>
    <div className="shapes absolute left-0 top-0 h-full w-full">
    <svg
        width="27"
        height="29"
        class="shape s1 absolute left-[2%] top-[10%]"
      ...
      <svg
        width="26"
        height="26"
        class="shape s2 absolute left-[18%] top-[30%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="30"
        height="25"
        class="shape s3 absolute left-[5%] bottom-[30%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="15"
        height="23"
        class="shape s4 absolute left-[2%] bottom-[10%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
      ...
      <svg
        width="15"
        height="23"
        class="shape s5 absolute left-[44%] top-[10%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
          transform="rotate(30 9.86603 10.13397)"
      ...
      <svg
        width="49"
        height="17"
        class="shape s6 absolute left-[36%] bottom-[10%]"
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <svg
        width="26"
        height="26"
        class="shape s7 absolute top-[20%] right-[25%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="19"
        height="21"
        class="shape s8 absolute right-[24%] bottom-[20%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
      ...
      <svg
        width="30"
        height="25"
        class="shape s9 absolute right-[2%] top-[10%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="47"
        height="29"
        class="shape s10 absolute top-[45%] right-[11%]"
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <svg
        width="33"
        height="20"
        class="shape s11 absolute bottom-[10%] right-[2%]"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
